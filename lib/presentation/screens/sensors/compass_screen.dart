  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: compassHeading.when(
        data: (heading) => Center(
          child: Compass(heading: heading ?? 0),
        ),
        ...
        Stack(
          ...
          children: [
            ...
            AnimatedRotation(
              ...
              child: Image.asset('assets/images/compass/quadrant-3.png'),
            ),
            Image.asset('assets/images/compass/needle-7.png')
          ],
        )
      ],
    );
